...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @tags Query
   * @name QueryDataAll
   * @summary Queries a list of Data items.
   * @request GET:/kvs/kvs/data
   */
  queryDataAll = (
    query?: {
    ...
    this.request<KvsQueryAllDataResponse, RpcStatus>({
      path: `/kvs/kvs/data`,
      method: "GET",
      query: query,
      format: "json",
   ...
   * @tags Query
   * @name QueryData
   * @summary Queries a Data by index.
   * @request GET:/kvs/kvs/data/{index}
   */
  queryData = (index: string, params: RequestParams = {}) =>
    this.request<KvsQueryGetDataResponse, RpcStatus>({
      path: `/kvs/kvs/data/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
